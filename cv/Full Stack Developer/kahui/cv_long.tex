...
\usepackage[a4paper,left=2.5cm,right=2.5cm,bottom=2.5cm,headheight=60pt,headsep=0.5cm]{geometry}
\usepackage{enumitem}
...
\section{\textcolor{section_4}{Skills}}
\vspace{-\parskip}
\vspace{-0.5em}
...
\vspace{-\baselineskip}
{
	...
	\begin{tabularx}{\textwidth}{@{}l p{0.20cm} X @{}}
		...
		% \pagebreak
		\texttt{\large 2017 - 2019} %\vspace{-1mm} \\ \texttt{\footnotesize /02} \hspace{1.5em} \texttt{\footnotesize /02}}
		...
		%& & {\small Taught upper secondary express students Physics and Mathematics as an intern. Kickstarted the QSS Makerspace for students to explore their interests in tinkering with things.} \\
		\texttt{\large 2015 - 2016} %\vspace{-1mm} \\ \texttt{\footnotesize /02} \hspace{1.5em} \texttt{\footnotesize /06}}
...
%{
	...
	%\begin{tabularx}{\textwidth}{@{}l p{0.3cm} X@{}}
		...
		&& {\small Carried out Photon Statistics experiments in the photonics lab. Lorem  ipsum dolor shit to explain what you did but dont repeat whatever you alr said.%Created equipment interfacing scripts on Linux using \code{Python 3} with libraries such as \code{pyusb} and automated said scripts for repeated data acquisition and processing. Aggregated and analysed large datasets with \code{numpy} and \code{gnuplot}. Also enabled remote monitoring, experimentation and extraction of data without physical access to the lab through reverse \code{SSH}.
		}\\
		{\texttt{\large 2011 - 2016}} & & \textbf{Electronic Communications and Computer Club %(EC\textsuperscript{3})
